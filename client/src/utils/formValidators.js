...
export const tooYoung = (value) =>
  value && value < 15 ? 'You do not meet the minimum age requirement!' : undefined;

export const notGmail = (value) =>
  value && !/.+@gmail\.com/.test(value) ? 'Really? You still use this for your email?' : undefined;
...
export const strongPassword = (value) =>
  value && !/^([A-Z]{1,})([a-z]{1,})([0-9]{1,})([!@#$&*.-_%]{1,})$/.test(value)

...
const Basics = ({ pristine, submitting, handleSubmit, updateProfile }) => (
  <Segment>
    ...
    <Form onSubmit={handleSubmit(updateProfile)}>
      <Form.Group inline>
        <label>Gender: </label>
        <Field name="gender" value="male" label="Male" type="radio" component={RadioInput} />
        <Field name="gender" value="female" label="Female" type="radio" component={RadioInput} />
        <Field name="gender" value="other" label="Other" type="radio" component={RadioInput} />
      </Form.Group>
      <Field
        name="dob"
        component={DateInput}

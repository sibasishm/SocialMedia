...
const Education = ({ pristine, submitting, handleSubmit, education, updateProfile }) => (
  <Segment>
    <Header dividing size="large" content="Education background" />
    {education && <Accordion content={createContentForAccordion(education)} />}
    <Form style={{ marginTop: '1rem' }} onSubmit={handleSubmit(updateProfile)}>
      ...
      <Button disabled={pristine || submitting} size="large" positive content="Add Education" />
    </Form>
  </Segment>
);
